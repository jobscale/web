...
RUN ln -sfn tls ssl && mkdir web && ln -sfn /var/site/projects/_/public web/_ \
 && ln -sfn /var/site/projects/_/assets web/cdn \
 && ln -sfn /var/site/projects/_/error web/error
