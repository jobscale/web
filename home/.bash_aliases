...
alias kube-kind='ln -sfn $(kind get kubeconfig-path --name="kind") $HOME/.kube/config'
alias kube-gke='ln -sfn $HOME/.kube/config-gke $HOME/.kube/config'
alias kube-aks='ln -sfn $HOME/.kube/config-aks $HOME/.kube/config'
alias kube-eks='ln -sfn $HOME/.kube/config-eks $HOME/.kube/config'
